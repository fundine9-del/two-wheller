...
export const ArrowRight=icon('', true), CalendarDays=icon('□'), ChevronRight=icon('›'), Clock3=icon('◷'), Facebook=icon('f'), Image=icon('▧'), Instagram=icon('◎'), MapPin=icon('•'), Menu=icon('☰'), Mountain=icon('⌁'), Play=icon('▶'), Search=icon('⌕'), Users=icon('♙'), X=icon('×')
